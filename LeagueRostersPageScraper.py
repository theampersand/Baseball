...
class LeagueRostersPageScraper:
    """Processes ElementTree of the league roster page on an ESPN fantasy baseball league
    can create sets of Players and Teams and correlate them

    """

    def __init__(self, league_rosters_page):
        self.league_rosters_page = league_rosters_page
        self.players = set()
        self.teams = set()

    def scrape_league_rosters_page(self):
        self.build_teams()
        self.build_players()